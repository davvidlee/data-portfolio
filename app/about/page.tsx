  ...
  return (
    <section className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-8 text-lg text-gray-750">
        ...
        <h2 className={title({ class: "text-center mb-12", color: "violet" })}>How It Started</h2>
        <p>
        ...
        <h2 className={title({ class: "text-center mb-12", color: "violet" })}>My Work</h2>
        <p>
        ...
        <h2 className={title({ class: "text-center mb-12", color: "violet" })}>Outside of Work</h2>
        <p>
